...
<html lang="en-GB" prefix="og: http://ogp.me/ns#">
    <head>
        ...
        <title>Little Elk | Modern designs and homewares</title>
    ...
    <body>
        <div class="lesp_splash-wrap">
            <main class="lesp_splash-cont">
                <img src="img/little-elk-logo.png" width="200" height="315" alt="Little Elk">
                <h1>Little Elk</h1>
                <div class="lesp_splash-desc">
                    Website coming soon
                </div>
            </main>
        </div>
